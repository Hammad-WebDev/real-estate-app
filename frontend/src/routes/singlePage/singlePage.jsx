        ...
        <div className="wrapper">
          ...
          <div className="buttons">
            <button
              ...
              disabled={isSelfPost}
              title={isSelfPost ? "You cannot chat with yourself" : "Send a message to the owner"}
              style={{
                opacity: isSelfPost ? 0.5 : 1,
                cursor: isSelfPost ? "not-allowed" : "pointer",
              }}
            >
              <img src="/chat.png" alt="" />
              {isSelfPost ? "Cannot chat with yourself" : "Send a Message"}
            </button>
            <button
              onClick={handleSave}
              style={{
